...
console.log((_b = (_a = myHouse.address) === null || _a === void 0 ? void 0 : _a.city) !== null && _b !== void 0 ? _b : "City not available"); // Expected Output: "New York"
// Objeto sin dirección
const noCityHouse = {};
// Acceso a la ciudad de noCityHouse
console.log((_d = (_c = noCityHouse.address) === null || _c === void 0 ? void 0 : _c.city) !== null && _d !== void 0 ? _d : "City not available"); // Expected Output: "City not available"
